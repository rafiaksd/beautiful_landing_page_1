...
export default function ProjectsSection() {
  ...
  return (
    <section
      className={`scroll-fade py-20 px-6 md:px-12 lg:px-20 bg-white`}
      data-delay="0.3"
    >
      <div className="max-w-7xl mx-auto text-center">
        ...
        <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 relative inline-block">
          ...
          <span className="absolute left-0 -bottom-2 w-full h-[3px] bg-red-400 rounded-full"></span>
        </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {projects.map((proj) => (
            <div
              key={proj.id}
              className="bg-white rounded-2xl transition p-4 flex flex-col"
            >
              ...
              <h3 className="mt-2 text-lg font-semibold text-gray-900 leading-snug line-clamp-2">
                {proj.title}
              </h3>
