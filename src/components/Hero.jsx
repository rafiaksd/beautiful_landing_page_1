...
export default function Hero() {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-screen flex flex-col justify-center bg-gradient-to-br from-rose-50 via-white to-rose-50 overflow-hidden"
    >
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-20 left-20 w-96 h-96 bg-rose-100 rounded-full blur-3xl opacity-40"></div>
        <div className="absolute bottom-20 right-20 w-80 h-80 bg-red-100 rounded-full blur-3xl opacity-30"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-20">
        ...
        {/* Paragraph */}
        <p className="scroll-fade mt-6 text-lg text-gray-600 max-w-3xl mx-auto text-center" data-delay="0.3">
        ...
        <div className="scroll-fade mt-10 flex justify-center" data-delay="0.4">
          <a
            href="#proposal"
            className="inline-flex items-center rounded-full bg-red-500 text-white px-8 py-4 font-semibold hover:bg-red-600 transition shadow-lg"
          >
            Get a UI/UX Design Proposal – Zorg IT Dubai Rocket
          </a>
        </div>
